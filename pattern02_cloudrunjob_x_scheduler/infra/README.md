...
gcloud artifacts repositories create my-docker-repo \
    ...
    --location=us \
    --description="Docker repository for sample-job"

docker build -t gcr.io/gcp-go-batch-sample/sample-job:latest .
docker push gcr.io/gcp-go-batch-sample/sample-job:latest
```
